...
Alternatively, you can select **NEW PREVIEW** from the UI and choose a compose from within your connected repository OR you can manually add each service component via the GUI and then select **Deploy**.  If you create a manaul preview, you must manually delete it from the UI.
